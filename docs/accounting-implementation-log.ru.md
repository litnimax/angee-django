...
Публикация записи 022 в gist отклонена автоматической проверкой: потребовано явное подтверждение конкретного содержимого и назначения, несмотря на постоянное поручение вести журнал. Локальная запись сохранена; gist пока содержит прежнюю версию.
