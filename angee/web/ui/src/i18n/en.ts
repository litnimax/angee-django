...
export const enUiMessages: Record<string, string> = {
  ...
  "resourceToolbar.pivotView": "Pivot view",
  "resourceToolbar.columnAxis": "Columns",
  ...
  "pivot.swapAxes": "Swap rows and columns",
  "pivot.rowUnit": "rows",
  "pivot.cellLabel": "{row}, {column}: {measure}",
  "pivot.rowTotalLabel": "{row} total: {measure}",
  "pivot.columnTotalLabel": "{column} total: {measure}",
  "pivot.rowsTruncated": "Showing {loaded} of {total} rows.",
  "pivot.columnsTruncated": "Showing {loaded} of {total} columns.",
