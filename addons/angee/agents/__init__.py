...
``integrate_vcs.Source`` (``source_kind="skill"``), and an inference provider is an
``integrate.Integration`` child whose credential carries the API key. Owns no process
